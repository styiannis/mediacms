import { GlobalMediaCMS, MediaCMSConfig } from '../src/static/js/types';

export const sampleGlobalMediaCMS: GlobalMediaCMS = {
    profileId: 'john',
    site: {
        id: 'my-site',
...
export const sampleMediaCMSConfig: MediaCMSConfig = {
    api: {
        archive: {
            tags: '',
            categories: '',
