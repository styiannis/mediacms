...
// Behaviors to test:
// 1) Trims trailing slashes from base api url when building endpoints
// 2) Prefixes all endpoints correctly and strips any leading slashes in endpoint definitions
// 3) Adds required query params for featured/recommended and search endpoints
// 4) Builds nested user, archive, manage, search groups preserving structure
// 5) Works when endpoint paths already include query strings and when base api has path component
