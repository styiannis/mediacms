...
export function useItem(props: {
    ...
    const [
        duration,
        // setDuration
    ] = useState(''); // @todo: Check this
    const [
        publishDate,
        // setPublishDate   // @todo: Check this
    ] = useState('');
    // const [publishDateTime, setPublishDateTime] = useState('');  // @todo: Remove it

    // const itemType = props.type; // @todo: Remove it
