...
export function memberConfig(
    ...
    ret.can.addComment = ret.can.addComment && features?.media?.actions?.comment === true;
    ret.can.mentionComment = ret.can.mentionComment && features?.media?.actions?.comment_mention === true;

    ret.can.likeMedia = features?.media?.actions?.like === false ? false : true;
    ret.can.dislikeMedia = features?.media?.actions?.dislike === false ? false : true;
    ret.can.reportMedia = features?.media?.actions?.report === true;

    ret.can.downloadMedia = features?.media?.actions?.download === true;
    ret.can.saveMedia = features?.media?.actions?.save === true;
    ret.can.shareMedia = features?.media?.actions?.share === false ? false : true;
